...
typedef struct {
    int16_t expNum, term1Num, term2Num;
    flag done;
} sequenceT;
...
static int32_t int32NextP1( sequenceT *sequencePtr )
{
    uint8_t termNum;
    int32_t z;
...
static int32_t int32NextP2( sequenceT *sequencePtr )
{
    uint8_t term1Num, term2Num;
    int32_t z;
...
static const uint64_t int64P1[ int64NumP1 ] = {
...
static int64_t int64NextP1( sequenceT *sequencePtr )
{
    uint8_t termNum;
    int64_t z;
...
static const int64_t int64NumP2 = ( int64NumP1 * int64NumP1 + int64NumP1 ) / 2;

static int64_t int64NextP2( sequenceT *sequencePtr )
{
    uint8_t term1Num, term2Num;
    int64_t z;
...
static int64_t int64RandomP3( void )
{
...
static const uint64_t int64PInfWeightMasks[ int64NumPInfWeightMasks ] = {
    LIT64( 0xFFFFFFFFFFFFFFFF ),
    LIT64( 0x7FFFFFFFFFFFFFFF ),
    LIT64( 0x3FFFFFFFFFFFFFFF ),
    LIT64( 0x1FFFFFFFFFFFFFFF ),
...
static const uint64_t int64PInfWeightOffsets[ int64NumPInfWeightMasks ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0xC000000000000000 ),
    LIT64( 0xE000000000000000 ),
    LIT64( 0xF000000000000000 ),
...
static int64_t int64RandomPInf( void )
{
    int8_t weightMaskNum;
...
static const uint32_t float32QIn[  ] = {
...
static const uint32_t float32QOut[  ] = {
#ifdef __HAS_SUBNORMAL
    0x00000000,		/* positive, subnormal		*/
#endif
    0x00800000,		/* positive, -126		*/
...
static const uint32_t float32P1[  ] = {
    0x00000000,
    0x00000001,
    0x007FFFFF,
    0x007FFFFE
...
static const uint32_t float32P2[  ] = {
    0x00000000,
    0x00000001,
    0x00000002,
    0x00000004,
...
enum {
    float32NumQIn  = sizeof(float32QIn)/sizeof(float32QIn[0]),
    float32NumQOut = sizeof(float32QOut)/sizeof(float32QOut[0]),
    float32NumP1   = sizeof(float32P1)/sizeof(float32P1[0]),
    float32NumP2   = sizeof(float32P2)/sizeof(float32P2[0])
};


static const uint32_t float32NumQInP1 = float32NumQIn * float32NumP1;
static const uint32_t float32NumQOutP1 = float32NumQOut * float32NumP1;

static float32 float32NextQInP1( sequenceT *sequencePtr )
{
    uint8_t expNum, sigNum;
    float32 z;
...
static const uint32_t float32NumQInP2 = float32NumQIn * float32NumP2;
static const uint32_t float32NumQOutP2 = float32NumQOut * float32NumP2;
...
static const uint32_t float32QInfWeightMasks[ float32NumQInfWeightMasks ] = {
    0x7F800000,
    0x7F800000,
    0x3F800000,
    0x1F800000,
...
static const uint32_t float32QInfWeightOffsets[ float32NumQInfWeightMasks ] = {
    0x00000000,
    0x00000000,
    0x20000000,
    0x30000000,
...
static float32 float32Random( void )
{
    ...
    // Just to silent compiler warning...
    ret = 0;
    return ret;
}
...
static const uint32_t float64QIn[  ] = {
#ifdef __HAS_SUBNORMAL
    0x00000000,		/* positive, subnormal		*/
#endif
...
static const uint32_t float64QOut[  ] = {
#ifdef __HAS_SUBNORMAL
    0x00000000,		/* positive, subnormal		*/
#endif
    0x00100000,		/* positive, -1022		*/
...
static const struct { bits32 high, low; } float64P1[  ] = {
...
static const struct { bits32 high, low; } float64P2[  ] = {
    { 0x00000000, 0x00000000 },
    { 0x00000000, 0x00000001 },
...
enum {
    float64NumQIn  =  sizeof(float64QIn)/sizeof(float64QIn[0]),
    float64NumQOut =  sizeof(float64QOut)/sizeof(float64QOut[0]),
    float64NumP1   =  sizeof(float64P1)/sizeof(float64P1[0]),
    float64NumP2   =  sizeof(float64P2) / sizeof(float64P2[0])
};


static const uint32_t float64NumQInP1 = float64NumQIn * float64NumP1;
static const uint32_t float64NumQOutP1 = float64NumQOut * float64NumP1;
...
static const uint32_t float64NumQInP2 = float64NumQIn * float64NumP2;
static const uint32_t float64NumQOutP2 = float64NumQOut * float64NumP2;
...
{
    int8_t sigNum1, sigNum2;
    uint32_t sig1Low, sig2Low, zLow;
    float64 z;
...
static const uint32_t float64QInfWeightMasks[ float64NumQInfWeightMasks ] = {
    0x7FF00000,
    0x7FF00000,
    0x3FF00000,
    0x1FF00000,
...
static const uint32_t float64QInfWeightOffsets[ float64NumQInfWeightMasks ] = {
    0x00000000,
    0x00000000,
    0x20000000,
    0x30000000,
...
static float64 float64RandomQInfP3( void )
{
    ...
    SETFLOAT64(
        z,
          ( ( (uint32_t) ( randomUint8() & 1 ) )<<31 )
        | (   (   ( ( (uint32_t) ( randomUint16() & 0xFFF ) )<<20 )
...
static const uint16_t floatx80QIn[  ] = {
#ifdef __HAS_SUBNORMAL
...
static const uint16_t floatx80QOut[  ] = {
#ifdef __HAS_SUBNORMAL
    0x0000,		/* positive, subnormal		*/
#endif
    0x0001,		/* positive, -16382		*/
...
static const bits64 floatx80P1[  ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0x0000000000000001 ),
    LIT64( 0x7FFFFFFFFFFFFFFF ),
...
static const bits64 floatx80P2[  ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0x0000000000000001 ),
    LIT64( 0x0000000000000002 ),
    LIT64( 0x0000000000000004 ),
...
enum {
    floatx80NumQIn  =  sizeof(floatx80QIn)/sizeof(floatx80QIn[0]),
    floatx80NumQOut =  sizeof(floatx80QOut)/sizeof(floatx80QOut[0]),
    floatx80NumP1   =  sizeof(floatx80P1)/sizeof(floatx80P1[0]),
    floatx80NumP2   =  sizeof(floatx80NumP2)/sizeof(floatx80NumP2[0])
};

static const uint32_t floatx80NumQInP1 = floatx80NumQIn * floatx80NumP1;
static const uint32_t floatx80NumQOutP1 = floatx80NumQOut * floatx80NumP1;

static floatx80 floatx80NextQInP1( sequenceT *sequencePtr )
{
    int16_t expNum, sigNum;
    floatx80 z;
...
static const uint32_t floatx80NumQInP2 = floatx80NumQIn * floatx80NumP2;
static const uint32_t floatx80NumQOutP2 = floatx80NumQOut * floatx80NumP2;
...
static const uint16_t floatx80QInfWeightMasks[ floatx80NumQInfWeightMasks ] = {
    0x7FFF,
    0x7FFF,
    0x3FFF,
    0x1FFF,
...
static const uint16_t floatx80QInfWeightOffsets[ floatx80NumQInfWeightMasks ] = {
    0x0000,
    0x0000,
    0x2000,
    0x3000,
...
static floatx80 floatx80RandomQInfP3( void )
{
    ...
    z.high |= ( (uint16_t) ( randomUint8() & 1 ) )<<15;
    return z;
...
static const uint64_t float128QIn[  ] = {
#ifdef __HAS_SUBNORMAL
...
static const uint64_t float128QOut[  ] = {
#ifdef __HAS_SUBNORMAL
    LIT64( 0x0000000000000000 ),	/* positive, subnormal		*/
#endif
    LIT64( 0x0001000000000000 ),	/* positive, -16382		*/
...
static const struct { bits64 high, low; } float128P1[  ] = {
...
static const struct { bits64 high, low; } float128P2[  ] = {
    { LIT64( 0x0000000000000000 ), LIT64( 0x0000000000000000 ) },
    { LIT64( 0x0000000000000000 ), LIT64( 0x0000000000000001 ) },
...
enum {
    float128NumQIn  =  sizeof(float128QIn)/sizeof(float128QIn[0]),
    float128NumQOut =  sizeof(float128NumQOut)/sizeof(float128NumQOut[0]),
    float128NumP1   =  sizeof(float128P1)/sizeof(float128P1[0]),
    float128NumP2   =  sizeof(float128NumP2)/sizeof(float128NumP2[0])
};

static const uint32_t float128NumQInP1 = float128NumQIn * float128NumP1;
static const uint32_t float128NumQOutP1 = float128NumQOut * float128NumP1;
...
static const uint32_t float128NumQInP2 = float128NumQIn * float128NumP2;
static const uint32_t float128NumQOutP2 = float128NumQOut * float128NumP2;
...
{
    int16_t sigNum1, sigNum2;
    uint64_t sig1Low, sig2Low;
    float128 z;
...
static const uint64_t float128QInfWeightMasks[ float128NumQInfWeightMasks ] = {
    LIT64( 0x7FFF000000000000 ),
    LIT64( 0x7FFF000000000000 ),
...
static const uint64_t float128QInfWeightOffsets[ float128NumQInfWeightMasks ] = {
    LIT64( 0x0000000000000000 ),
    LIT64( 0x0000000000000000 ),
    LIT64( 0x2000000000000000 ),
...
static float128 float128RandomQInfP3( void )
{
    ...
    z.high =
          ( ( (uint64_t) ( randomUint8() & 1 ) )<<63 )
        | (   (   ( ( (uint64_t) randomUint16() )<<48 )
...
void testCases_setLevel( int8_t levelIn )
{
...
static int8_t sequenceType;
static sequenceT sequenceA, sequenceB;
static int8_t subcase;

uint32_t testCases_total;
flag testCases_done;
...
void testCases_initSequence( int8_t sequenceTypeIn )
{
...
int32_t testCases_a_int32;
#ifdef BITS64
int64_t testCases_a_int64;
#endif
