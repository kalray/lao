...
extern uint32_t maxErrorCount;
extern flag checkNaNs;
extern int8_t *trueFlagsPtr;
extern int8_t ( *testFlagsFunctionPtr )( void );
...
void test_a_int32_z_float32( float32 ( int32_t ), float32 ( int32_t ) );
void test_a_int32_z_float64( float64 ( int32_t ), float64 ( int32_t ) );
#ifdef FLOATX80
void test_a_int32_z_floatx80( floatx80 ( int32_t ), floatx80 ( int32_t ) );
#endif
#ifdef FLOAT128
void test_a_int32_z_float128( float128 ( int32_t ), float128 ( int32_t ) );
#endif
#ifdef BITS64
void test_a_int64_z_float32( float32 ( int64_t ), float32 ( int64_t ) );
void test_a_int64_z_float64( float64 ( int64_t ), float64 ( int64_t ) );
#ifdef FLOATX80
void test_a_int64_z_floatx80( floatx80 ( int64_t ), floatx80 ( int64_t ) );
#endif
#ifdef FLOAT128
void test_a_int64_z_float128( float128 ( int64_t ), float128 ( int64_t ) );
#endif
#endif

void test_a_float32_z_int32( int32_t ( float32 ), int32_t ( float32 ) );
#ifdef BITS64
void test_a_float32_z_int64( int64_t ( float32 ), int64_t ( float32 ) );
#endif
...
void test_a_float64_z_int32( int32_t ( float64 ), int32_t ( float64 ) );
#ifdef BITS64
void test_a_float64_z_int64( int64_t ( float64 ), int64_t ( float64 ) );
#endif
...
void test_a_floatx80_z_int32( int32_t ( floatx80 ), int32_t ( floatx80 ) );
#ifdef BITS64
void test_a_floatx80_z_int64( int64_t ( floatx80 ), int64_t ( floatx80 ) );
#endif
...
void test_a_float128_z_int32( int32_t ( float128 ), int32_t ( float128 ) );
#ifdef BITS64
void test_a_float128_z_int64( int64_t ( float128 ), int64_t ( float128 ) );
#endif
