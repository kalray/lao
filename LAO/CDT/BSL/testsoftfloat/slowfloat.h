...
extern int8_t slow_float_rounding_mode;
extern int8_t slow_float_exception_flags;
extern int8_t slow_float_detect_tininess;
#ifdef FLOATX80
extern int8_t slow_floatx80_rounding_precision;
#endif

float32 slow_int32_to_float32( int32_t );
float64 slow_int32_to_float64( int32_t );
#ifdef FLOATX80
floatx80 slow_int32_to_floatx80( int32_t );
#endif
#ifdef FLOAT128
float128 slow_int32_to_float128( int32_t );
#endif
#ifdef BITS64
float32 slow_int64_to_float32( int64_t );
float64 slow_int64_to_float64( int64_t );
#ifdef FLOATX80
floatx80 slow_int64_to_floatx80( int64_t );
#endif
#ifdef FLOAT128
float128 slow_int64_to_float128( int64_t );
#endif
#endif

int32_t slow_float32_to_int32( float32 );
int32_t slow_float32_to_int32_round_to_zero( float32 );
#ifdef BITS64
int64_t slow_float32_to_int64( float32 );
int64_t slow_float32_to_int64_round_to_zero( float32 );
#endif
...
float32 slow_float32_max( float32, float32 );
float32 slow_float32_min( float32, float32 );
...
int32_t slow_float64_to_int32( float64 );
int32_t slow_float64_to_int32_round_to_zero( float64 );
#ifdef BITS64
int64_t slow_float64_to_int64( float64 );
int64_t slow_float64_to_int64_round_to_zero( float64 );
#endif
...
float64 slow_float64_max( float64, float64 );
float64 slow_float64_min( float64, float64 );
...
int32_t slow_floatx80_to_int32( floatx80 );
int32_t slow_floatx80_to_int32_round_to_zero( floatx80 );
#ifdef BITS64
int64_t slow_floatx80_to_int64( floatx80 );
int64_t slow_floatx80_to_int64_round_to_zero( floatx80 );
#endif
...
int32_t slow_float128_to_int32( float128 );
int32_t slow_float128_to_int32_round_to_zero( float128 );
#ifdef BITS64
int64_t slow_float128_to_int64( float128 );
int64_t slow_float128_to_int64_round_to_zero( float128 );
#endif
