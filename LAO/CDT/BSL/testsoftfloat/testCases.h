...
void testCases_setLevel( int8_t );

void testCases_initSequence( int8_t );
enum {
...
extern uint32_t testCases_total;
extern flag testCases_done;

void testCases_next( void );

extern int32_t testCases_a_int32;
#ifdef BITS64
extern int64_t testCases_a_int64;
#endif
